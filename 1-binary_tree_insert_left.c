...
/**
 * binary_tree_insert_left - inserts a new node as left of the parent node given. if parent
 * already has a left child, insert the left child to the left of new node.
