...
/**
 * binary_tree_insert_right - inserts a new node as right of the parent node given. if parent
 * already has a right child, insert the right child to the left of new node.
